...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FeathersPlayground", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FeathersPlayground", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FeathersPlayground";
		app.meta["name"] = "FeathersPlayground";
		app.meta["packageName"] = "FeathersPlayground";
